...
export function createStore() {
  ...
  if (!url || !key) throw Object.assign(new Error('League storage is not configured on this server.'),
    { status: 503, detail: 'SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY must both be set with Functions scope.' });
